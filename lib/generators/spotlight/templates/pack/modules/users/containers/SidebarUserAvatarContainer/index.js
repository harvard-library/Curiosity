...
const SidebarUserAvatarContainer = props => {
	let user;
	let userName = '';
	let avatarUrl = '/assets/default_user.jpg';
	...
	return <SidebarUserAvatar avatarUrl={avatarUrl} name={userName} />;
};

export default compose(userAvatarQuery)(SidebarUserAvatarContainer);
