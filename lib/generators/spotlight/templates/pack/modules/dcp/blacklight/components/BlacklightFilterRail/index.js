						...
						<AccordionItem>
							<a onClick={this.toggleFilterArrow.bind(this, 'type')}>
								<AccordionItemTitle>
									<h3>Type</h3>
									<div>
										<img src="/assets/down_arrow.png" className={`hl__filter-rail__arrow ${ this.state.filterTypeActive ? "filterItemActive" : ''}`} alt="down arrow"/>
									</div>
								</AccordionItemTitle>
							</a>
							<AccordionItemBody>
						...
						<AccordionItem>
							<a onClick={this.toggleFilterArrow.bind(this, 'format')}>
								<AccordionItemTitle>
									<h3>Format</h3>
									<div>
										<img src="/assets/down_arrow.png" className={`hl__filter-rail__arrow ${ this.state.filterFormatActive ? "filterItemActive" : ''}`} alt="down arrow"/>
									</div>
								</AccordionItemTitle>
							</a>
							<AccordionItemBody>
						...
						<AccordionItem>
							<a onClick={this.toggleFilterArrow.bind(this, 'repo')}>
								<AccordionItemTitle>
									<h3>Repository</h3>
									<div>
										<img src="/assets/down_arrow.png" className={`hl__filter-rail__arrow ${ this.state.filterRepoActive ? "filterItemActive" : ''}`} alt="down arrow"/>
									</div>
								</AccordionItemTitle>
							</a>
							<AccordionItemBody>
