...
// component
import HomeItemHighlights from '../../components/BlacklightHome/sections/HomeItemHighlights';


class HomeItemHighlightsContainer extends React.Component {
	componentDidMount() {
...
HomeItemHighlightsContainer.propTypes = {
...
export default connect(mapStateToProps, mapDispatchToProps)(HomeItemHighlightsContainer);
