...
const HomeCollectionHighlightsList = ({collections}) => {
	return (
		<section className="hl__blacklightHome__highlights">
			...
			<button className="hl__blacklightHome__moreHighlights"><img className="moreHighlightsIcon" src="assets/moreHighlights.svg" alt=""/>More Highlights</button>
			...
			<div className="hl__blacklightHome__seeAllContainer">
				...
				>
					See all collections <img className="seeAllIcon" src="assets/arrow_right.svg" alt=""/>
				</Link>
			</div>
