						...
						<AccordionItem>
							<a onClick={this.toggleFilterArrow.bind(this, 'date')}>
								<AccordionItemTitle >
									<h3>Date Range</h3>
									<div>
										<img src="/assets/down_arrow.png" className={`hl__filter-rail__arrow ${ this.state.filterDateActive ? "filterItemActive" : ''}`} alt="down arrow"/>
						...
						<AccordionItem>
							<a onClick={this.toggleFilterArrow.bind(this, 'genre')}>
								<AccordionItemTitle>
									<h3>Genre</h3>
									<div>
										<img src="/assets/down_arrow.png" className={`hl__filter-rail__arrow ${ this.state.filterGenreActive ? "filterItemActive" : ''}`} alt="down arrow"/>
									</div>
								</AccordionItemTitle>
							</a>
							<AccordionItemBody>
						...
						<AccordionItem>
							<a onClick={this.toggleFilterArrow.bind(this, 'language')}>
								<AccordionItemTitle>
									<h3>Language</h3>
									<div>
										<img src="/assets/down_arrow.png" className={`hl__filter-rail__arrow ${ this.state.filterLanguageActive ? "filterItemActive" : ''}`} alt="down arrow"/>
									</div>
								</AccordionItemTitle>
							</a>
							<AccordionItemBody>
						...
						<AccordionItem>
							<a onClick={this.toggleFilterArrow.bind(this, 'place')}>
								<AccordionItemTitle>
									<h3>Place</h3>
									<div>
										<img src="/assets/down_arrow.png" className={`hl__filter-rail__arrow ${ this.state.filterPlaceActive ? "filterItemActive" : ''}`} alt="down arrow"/>
									</div>
								</AccordionItemTitle>
							</a>
							<AccordionItemBody>
						...
						<AccordionItem>
							<a onClick={this.toggleFilterArrow.bind(this, 'repository')}>
								<AccordionItemTitle>
									<h3>Repository</h3>
									<div>
										<img src="/assets/down_arrow.png" className={`hl__filter-rail__arrow ${ this.state.filterRepositoryActive ? "filterItemActive" : ''}`} alt="down arrow"/>
									</div>
								</AccordionItemTitle>
							</a>
							<AccordionItemBody>
						...
						<AccordionItem>
							<a onClick={this.toggleFilterArrow.bind(this, 'subject')}>
								<AccordionItemTitle>
									<h3>Subject</h3>
									<div>
										<img src="/assets/down_arrow.png" className={`hl__filter-rail__arrow ${ this.state.filterSubjectActive ? "filterItemActive" : ''}`} alt="down arrow"/>
									</div>
								</AccordionItemTitle>
							</a>
							<AccordionItemBody>
	...
	<button
		...
		{facet} ({facets.facet_fields.subjects_tesim[i + 1]})
                 ...
                 More
							...
							<img src="/assets/chevron_right.svg" alt="chevron right icon"/>
						</div>
            */}
					</Accordion>
				</div>
