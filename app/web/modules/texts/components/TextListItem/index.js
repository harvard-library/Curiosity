		...
		<div className="textListItem">
			...
			<div
				className={`
					...
					${props.coverImage ? 'textListItemBackgroundWithImage' : ''}
				`}
			>
				<div className="textCount">{props.itemsCount} annotations</div>
				<Link to={textUrl}>
					<h3>{props.collection.textGroup.work.english_title}</h3>
				</Link>
				<p>{prune(props.collection.textGroup.work.urn, 90)}</p>
				<Link to={textUrl} className="textLink">
					<span className="textLinkLabel">View the text</span>
